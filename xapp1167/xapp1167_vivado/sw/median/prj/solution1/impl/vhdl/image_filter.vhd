...
architecture behav of image_filter is 
    ...
    "image_filter,hls_ip_2015_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=6.666670,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=5.656668,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=621,HLS_SYN_LUT=833}";
    ...
    signal image_filter_Block_Mat_exit8113_proc_U0_ap_start : STD_LOGIC;
    signal image_filter_Block_Mat_exit8113_proc_U0_ap_done : STD_LOGIC;
    signal image_filter_Block_Mat_exit8113_proc_U0_ap_continue : STD_LOGIC;
    signal image_filter_Block_Mat_exit8113_proc_U0_ap_idle : STD_LOGIC;
    signal image_filter_Block_Mat_exit8113_proc_U0_ap_ready : STD_LOGIC;
    signal image_filter_Block_Mat_exit8113_proc_U0_rows : STD_LOGIC_VECTOR (31 downto 0);
    signal image_filter_Block_Mat_exit8113_proc_U0_cols : STD_LOGIC_VECTOR (31 downto 0);
    signal image_filter_Block_Mat_exit8113_proc_U0_ap_return_0 : STD_LOGIC_VECTOR (11 downto 0);
    signal image_filter_Block_Mat_exit8113_proc_U0_ap_return_1 : STD_LOGIC_VECTOR (11 downto 0);
    signal image_filter_Block_Mat_exit8113_proc_U0_ap_return_2 : STD_LOGIC_VECTOR (11 downto 0);
    signal image_filter_Block_Mat_exit8113_proc_U0_ap_return_3 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_0_rows_V_channel : STD_LOGIC;
    ...
    signal ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_0_cols_V_channel : STD_LOGIC;
    ...
    signal ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_1_cols_V_channel : STD_LOGIC;
    ...
    signal ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_1_rows_V_channel : STD_LOGIC;
    ...
    signal ap_reg_procdone_image_filter_Block_Mat_exit8113_proc_U0 : STD_LOGIC := '0';
    ...
    component image_filter_Block_Mat_exit8113_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    image_filter_Block_Mat_exit8113_proc_U0 : component image_filter_Block_Mat_exit8113_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => image_filter_Block_Mat_exit8113_proc_U0_ap_start,
        ap_done => image_filter_Block_Mat_exit8113_proc_U0_ap_done,
        ap_continue => image_filter_Block_Mat_exit8113_proc_U0_ap_continue,
        ap_idle => image_filter_Block_Mat_exit8113_proc_U0_ap_idle,
        ap_ready => image_filter_Block_Mat_exit8113_proc_U0_ap_ready,
        rows => image_filter_Block_Mat_exit8113_proc_U0_rows,
        cols => image_filter_Block_Mat_exit8113_proc_U0_cols,
        ap_return_0 => image_filter_Block_Mat_exit8113_proc_U0_ap_return_0,
        ap_return_1 => image_filter_Block_Mat_exit8113_proc_U0_ap_return_1,
        ap_return_2 => image_filter_Block_Mat_exit8113_proc_U0_ap_return_2,
        ap_return_3 => image_filter_Block_Mat_exit8113_proc_U0_ap_return_3);
    ...
    -- ap_reg_procdone_image_filter_Block_Mat_exit8113_proc_U0 assign process. --
    ap_reg_procdone_image_filter_Block_Mat_exit8113_proc_U0_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((ap_const_logic_1 = ap_sig_hs_done)) then 
                    ap_reg_procdone_image_filter_Block_Mat_exit8113_proc_U0 <= ap_const_logic_0;
                elsif ((image_filter_Block_Mat_exit8113_proc_U0_ap_done = ap_const_logic_1)) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((image_filter_Block_Mat_exit8113_proc_U0_ap_done = ap_const_logic_1) and (image_filter_Block_Mat_exit8113_proc_U0_ap_continue = ap_const_logic_1))) then 
                    ap_reg_ready_img_0_cols_V_channel_full_n <= ap_const_logic_0;
                elsif (((image_filter_Block_Mat_exit8113_proc_U0_ap_done = ap_const_logic_1) and (ap_const_logic_1 = img_0_cols_V_channel_full_n))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((image_filter_Block_Mat_exit8113_proc_U0_ap_done = ap_const_logic_1) and (image_filter_Block_Mat_exit8113_proc_U0_ap_continue = ap_const_logic_1))) then 
                    ap_reg_ready_img_0_rows_V_channel_full_n <= ap_const_logic_0;
                elsif (((image_filter_Block_Mat_exit8113_proc_U0_ap_done = ap_const_logic_1) and (img_0_rows_V_channel_full_n = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((image_filter_Block_Mat_exit8113_proc_U0_ap_done = ap_const_logic_1) and (image_filter_Block_Mat_exit8113_proc_U0_ap_continue = ap_const_logic_1))) then 
                    ap_reg_ready_img_1_cols_V_channel_full_n <= ap_const_logic_0;
                elsif (((image_filter_Block_Mat_exit8113_proc_U0_ap_done = ap_const_logic_1) and (ap_const_logic_1 = img_1_cols_V_channel_full_n))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((image_filter_Block_Mat_exit8113_proc_U0_ap_done = ap_const_logic_1) and (image_filter_Block_Mat_exit8113_proc_U0_ap_continue = ap_const_logic_1))) then 
                    ap_reg_ready_img_1_rows_V_channel_full_n <= ap_const_logic_0;
                elsif (((image_filter_Block_Mat_exit8113_proc_U0_ap_done = ap_const_logic_1) and (ap_const_logic_1 = img_1_rows_V_channel_full_n))) then 
    ...
    -- ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_0_cols_V_channel assign process. --
    ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_0_cols_V_channel_assign_proc : process(image_filter_Block_Mat_exit8113_proc_U0_ap_done, ap_reg_ready_img_0_cols_V_channel_full_n)
    begin
        if ((ap_const_logic_1 = ap_reg_ready_img_0_cols_V_channel_full_n)) then 
            ...
            ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_0_cols_V_channel <= image_filter_Block_Mat_exit8113_proc_U0_ap_done;
        end if; 
    end process;


    -- ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_0_rows_V_channel assign process. --
    ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_0_rows_V_channel_assign_proc : process(image_filter_Block_Mat_exit8113_proc_U0_ap_done, ap_reg_ready_img_0_rows_V_channel_full_n)
    begin
        if ((ap_reg_ready_img_0_rows_V_channel_full_n = ap_const_logic_1)) then 
            ...
            ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_0_rows_V_channel <= image_filter_Block_Mat_exit8113_proc_U0_ap_done;
        end if; 
    end process;


    -- ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_1_cols_V_channel assign process. --
    ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_1_cols_V_channel_assign_proc : process(image_filter_Block_Mat_exit8113_proc_U0_ap_done, ap_reg_ready_img_1_cols_V_channel_full_n)
    begin
        if ((ap_const_logic_1 = ap_reg_ready_img_1_cols_V_channel_full_n)) then 
            ...
            ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_1_cols_V_channel <= image_filter_Block_Mat_exit8113_proc_U0_ap_done;
        end if; 
    end process;


    -- ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_1_rows_V_channel assign process. --
    ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_1_rows_V_channel_assign_proc : process(image_filter_Block_Mat_exit8113_proc_U0_ap_done, ap_reg_ready_img_1_rows_V_channel_full_n)
    begin
        if ((ap_const_logic_1 = ap_reg_ready_img_1_rows_V_channel_full_n)) then 
            ...
            ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_1_rows_V_channel <= image_filter_Block_Mat_exit8113_proc_U0_ap_done;
        end if; 
    end process;
    ...
    ap_idle_assign_proc : process(image_filter_Block_Mat_exit8113_proc_U0_ap_idle, image_filter_AXIvideo2Mat_U0_ap_idle, image_filter_Loop_1_proc_U0_ap_idle, image_filter_Mat2AXIvideo_U0_ap_idle, img_0_rows_V_channel_empty_n, img_0_cols_V_channel_empty_n, img_1_rows_V_channel_empty_n, img_1_cols_V_channel_empty_n)
    begin
        if (((image_filter_Block_Mat_exit8113_proc_U0_ap_idle = ap_const_logic_1) and (ap_const_logic_1 = image_filter_AXIvideo2Mat_U0_ap_idle) and (ap_const_logic_1 = image_filter_Loop_1_proc_U0_ap_idle) and (ap_const_logic_1 = image_filter_Mat2AXIvideo_U0_ap_idle) and (ap_const_logic_0 = img_0_rows_V_channel_empty_n) and (ap_const_logic_0 = img_0_cols_V_channel_empty_n) and (ap_const_logic_0 = img_1_rows_V_channel_empty_n) and (ap_const_logic_0 = img_1_cols_V_channel_empty_n))) then 
    ...
    -- image_filter_Block_Mat_exit8113_proc_U0_ap_continue assign process. --
    image_filter_Block_Mat_exit8113_proc_U0_ap_continue_assign_proc : process(ap_sig_ready_img_0_rows_V_channel_full_n, ap_sig_ready_img_0_cols_V_channel_full_n, ap_sig_ready_img_1_cols_V_channel_full_n, ap_sig_ready_img_1_rows_V_channel_full_n)
    begin
        if (((ap_sig_ready_img_0_rows_V_channel_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_sig_ready_img_0_cols_V_channel_full_n) and (ap_const_logic_1 = ap_sig_ready_img_1_cols_V_channel_full_n) and (ap_const_logic_1 = ap_sig_ready_img_1_rows_V_channel_full_n))) then 
    ...
    image_filter_Block_Mat_exit8113_proc_U0_ap_start <= ap_start;
    image_filter_Block_Mat_exit8113_proc_U0_cols <= cols;
    image_filter_Block_Mat_exit8113_proc_U0_rows <= rows;
    ...
    img_0_cols_V_channel_din <= image_filter_Block_Mat_exit8113_proc_U0_ap_return_1;
    img_0_cols_V_channel_read <= image_filter_AXIvideo2Mat_U0_ap_ready;
    img_0_cols_V_channel_write <= ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_0_cols_V_channel;
    ...
    img_0_rows_V_channel_din <= image_filter_Block_Mat_exit8113_proc_U0_ap_return_0;
    img_0_rows_V_channel_read <= image_filter_AXIvideo2Mat_U0_ap_ready;
    img_0_rows_V_channel_write <= ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_0_rows_V_channel;
    img_1_cols_V_channel_U_ap_dummy_ce <= ap_const_logic_1;
    img_1_cols_V_channel_din <= image_filter_Block_Mat_exit8113_proc_U0_ap_return_3;
    img_1_cols_V_channel_read <= image_filter_Mat2AXIvideo_U0_ap_ready;
    img_1_cols_V_channel_write <= ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_1_cols_V_channel;
    ...
    img_1_rows_V_channel_din <= image_filter_Block_Mat_exit8113_proc_U0_ap_return_2;
    img_1_rows_V_channel_read <= image_filter_Mat2AXIvideo_U0_ap_ready;
    img_1_rows_V_channel_write <= ap_chn_write_image_filter_Block_Mat_exit8113_proc_U0_img_1_rows_V_channel;
end behav;
