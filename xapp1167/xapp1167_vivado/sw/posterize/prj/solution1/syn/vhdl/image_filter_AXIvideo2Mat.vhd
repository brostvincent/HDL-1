...
architecture behav of image_filter_AXIvideo2Mat is 
    ...
    signal tmp_12_fu_352_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_12_reg_433 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_4_reg_438 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_5_reg_443 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_4) and (exitcond2_fu_319_p2 = ap_const_lv1_0) and not(((ap_sig_bdd_120 and (ap_const_logic_1 = ap_reg_ppiten_pp1_it0)) or (ap_sig_bdd_133 and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1)))))) then
                tmp_12_reg_433 <= tmp_12_fu_352_p1;
                tmp_4_reg_438 <= p_Val2_s_phi_fu_235_p4(15 downto 8);
                tmp_5_reg_443 <= p_Val2_s_phi_fu_235_p4(23 downto 16);
            end if;
        end if;
    end process;
    ...
    img_data_stream_0_V_din <= tmp_12_reg_433;
    ...
    img_data_stream_1_V_din <= tmp_4_reg_438;
    ...
    img_data_stream_2_V_din <= tmp_5_reg_443;
    ...
    tmp_12_fu_352_p1 <= p_Val2_s_phi_fu_235_p4(8 - 1 downto 0);
