...
(* CORE_GENERATION_INFO="image_filter,hls_ip_2015_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=6.666670,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=5.833336,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=451,HLS_SYN_LUT=687}" *)
...
reg ap_idle;
reg    ap_rst_n_inv;
wire    image_filter_Block_Mat_exit653_proc_U0_ap_start;
wire    image_filter_Block_Mat_exit653_proc_U0_ap_done;
reg    image_filter_Block_Mat_exit653_proc_U0_ap_continue;
wire    image_filter_Block_Mat_exit653_proc_U0_ap_idle;
wire    image_filter_Block_Mat_exit653_proc_U0_ap_ready;
wire   [31:0] image_filter_Block_Mat_exit653_proc_U0_rows;
wire   [31:0] image_filter_Block_Mat_exit653_proc_U0_cols;
wire   [11:0] image_filter_Block_Mat_exit653_proc_U0_ap_return_0;
wire   [11:0] image_filter_Block_Mat_exit653_proc_U0_ap_return_1;
wire   [11:0] image_filter_Block_Mat_exit653_proc_U0_ap_return_2;
wire   [11:0] image_filter_Block_Mat_exit653_proc_U0_ap_return_3;
reg    ap_chn_write_image_filter_Block_Mat_exit653_proc_U0_img_0_rows_V_channel;
...
reg    ap_chn_write_image_filter_Block_Mat_exit653_proc_U0_img_0_cols_V_channel;
...
reg    ap_chn_write_image_filter_Block_Mat_exit653_proc_U0_img_1_rows_V_channel;
...
reg    ap_chn_write_image_filter_Block_Mat_exit653_proc_U0_img_1_cols_V_channel;
...
reg    ap_reg_procdone_image_filter_Block_Mat_exit653_proc_U0 = 1'b0;
reg    ap_sig_hs_done;
...
image_filter_Block_Mat_exit653_proc image_filter_Block_Mat_exit653_proc_U0(
    .ap_clk( ap_clk ),
    .ap_rst( ap_rst_n_inv ),
...
always @ (posedge ap_clk)
begin : ap_ret_ap_reg_procdone_image_filter_Block_Mat_exit653_proc_U0
    if (ap_rst_n_inv == 1'b1) begin
        ap_reg_procdone_image_filter_Block_Mat_exit653_proc_U0 <= ap_const_logic_0;
    end else begin
        if ((ap_const_logic_1 == ap_sig_hs_done)) begin
            ap_reg_procdone_image_filter_Block_Mat_exit653_proc_U0 <= ap_const_logic_0;
        end else if ((image_filter_Block_Mat_exit653_proc_U0_ap_done == ap_const_logic_1)) begin
...
begin : ap_ret_ap_reg_ready_img_0_cols_V_channel_full_n
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((image_filter_Block_Mat_exit653_proc_U0_ap_done == ap_const_logic_1) & (image_filter_Block_Mat_exit653_proc_U0_ap_continue == ap_const_logic_1))) begin
            ap_reg_ready_img_0_cols_V_channel_full_n <= ap_const_logic_0;
        end else if (((image_filter_Block_Mat_exit653_proc_U0_ap_done == ap_const_logic_1) & (ap_const_logic_1 == img_0_cols_V_channel_full_n))) begin
...
begin : ap_ret_ap_reg_ready_img_0_rows_V_channel_full_n
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((image_filter_Block_Mat_exit653_proc_U0_ap_done == ap_const_logic_1) & (image_filter_Block_Mat_exit653_proc_U0_ap_continue == ap_const_logic_1))) begin
            ap_reg_ready_img_0_rows_V_channel_full_n <= ap_const_logic_0;
        end else if (((image_filter_Block_Mat_exit653_proc_U0_ap_done == ap_const_logic_1) & (img_0_rows_V_channel_full_n == ap_const_logic_1))) begin
...
begin : ap_ret_ap_reg_ready_img_1_cols_V_channel_full_n
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((image_filter_Block_Mat_exit653_proc_U0_ap_done == ap_const_logic_1) & (image_filter_Block_Mat_exit653_proc_U0_ap_continue == ap_const_logic_1))) begin
            ap_reg_ready_img_1_cols_V_channel_full_n <= ap_const_logic_0;
        end else if (((image_filter_Block_Mat_exit653_proc_U0_ap_done == ap_const_logic_1) & (ap_const_logic_1 == img_1_cols_V_channel_full_n))) begin
...
begin : ap_ret_ap_reg_ready_img_1_rows_V_channel_full_n
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((image_filter_Block_Mat_exit653_proc_U0_ap_done == ap_const_logic_1) & (image_filter_Block_Mat_exit653_proc_U0_ap_continue == ap_const_logic_1))) begin
            ap_reg_ready_img_1_rows_V_channel_full_n <= ap_const_logic_0;
        end else if (((image_filter_Block_Mat_exit653_proc_U0_ap_done == ap_const_logic_1) & (ap_const_logic_1 == img_1_rows_V_channel_full_n))) begin
...
always @ (image_filter_Block_Mat_exit653_proc_U0_ap_done or ap_reg_ready_img_0_cols_V_channel_full_n)
begin
...
always @ (image_filter_Block_Mat_exit653_proc_U0_ap_done or ap_reg_ready_img_0_rows_V_channel_full_n)
begin
...
always @ (image_filter_Block_Mat_exit653_proc_U0_ap_done or ap_reg_ready_img_1_cols_V_channel_full_n)
begin
...
always @ (image_filter_Block_Mat_exit653_proc_U0_ap_done or ap_reg_ready_img_1_rows_V_channel_full_n)
begin
...
always @ (image_filter_Block_Mat_exit653_proc_U0_ap_idle or image_filter_AXIvideo2Mat_U0_ap_idle or image_filter_Loop_1_proc_U0_ap_idle or image_filter_Mat2AXIvideo_U0_ap_idle or img_0_rows_V_channel_empty_n or img_0_cols_V_channel_empty_n or img_1_rows_V_channel_empty_n or img_1_cols_V_channel_empty_n)
begin
    if (((image_filter_Block_Mat_exit653_proc_U0_ap_idle == ap_const_logic_1) & (ap_const_logic_1 == image_filter_AXIvideo2Mat_U0_ap_idle) & (ap_const_logic_1 == image_filter_Loop_1_proc_U0_ap_idle) & (ap_const_logic_1 == image_filter_Mat2AXIvideo_U0_ap_idle) & (ap_const_logic_0 == img_0_rows_V_channel_empty_n) & (ap_const_logic_0 == img_0_cols_V_channel_empty_n) & (ap_const_logic_0 == img_1_rows_V_channel_empty_n) & (ap_const_logic_0 == img_1_cols_V_channel_empty_n))) begin
...
always @ (ap_sig_ready_img_0_rows_V_channel_full_n or ap_sig_ready_img_0_cols_V_channel_full_n or ap_sig_ready_img_1_rows_V_channel_full_n or ap_sig_ready_img_1_cols_V_channel_full_n)
begin
    if (((ap_sig_ready_img_0_rows_V_channel_full_n == ap_const_logic_1) & (ap_const_logic_1 == ap_sig_ready_img_0_cols_V_channel_full_n) & (ap_const_logic_1 == ap_sig_ready_img_1_rows_V_channel_full_n) & (ap_const_logic_1 == ap_sig_ready_img_1_cols_V_channel_full_n))) begin
...
assign image_filter_Block_Mat_exit653_proc_U0_ap_start = ap_start;
assign image_filter_Block_Mat_exit653_proc_U0_cols = cols;
assign image_filter_Block_Mat_exit653_proc_U0_rows = rows;
...
assign img_0_cols_V_channel_din = image_filter_Block_Mat_exit653_proc_U0_ap_return_1;
assign img_0_cols_V_channel_read = image_filter_AXIvideo2Mat_U0_ap_ready;
assign img_0_cols_V_channel_write = ap_chn_write_image_filter_Block_Mat_exit653_proc_U0_img_0_cols_V_channel;
...
assign img_0_rows_V_channel_din = image_filter_Block_Mat_exit653_proc_U0_ap_return_0;
assign img_0_rows_V_channel_read = image_filter_AXIvideo2Mat_U0_ap_ready;
assign img_0_rows_V_channel_write = ap_chn_write_image_filter_Block_Mat_exit653_proc_U0_img_0_rows_V_channel;
assign img_1_cols_V_channel_U_ap_dummy_ce = ap_const_logic_1;
assign img_1_cols_V_channel_din = image_filter_Block_Mat_exit653_proc_U0_ap_return_3;
assign img_1_cols_V_channel_read = image_filter_Mat2AXIvideo_U0_ap_ready;
assign img_1_cols_V_channel_write = ap_chn_write_image_filter_Block_Mat_exit653_proc_U0_img_1_cols_V_channel;
...
assign img_1_rows_V_channel_din = image_filter_Block_Mat_exit653_proc_U0_ap_return_2;
assign img_1_rows_V_channel_read = image_filter_Mat2AXIvideo_U0_ap_ready;
assign img_1_rows_V_channel_write = ap_chn_write_image_filter_Block_Mat_exit653_proc_U0_img_1_rows_V_channel;
