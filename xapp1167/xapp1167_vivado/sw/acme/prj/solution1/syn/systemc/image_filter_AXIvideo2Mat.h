...
struct image_filter_AXIvideo2Mat : public sc_module {
    ...
    sc_signal< sc_lv<8> > tmp_34_fu_352_p1;
    sc_signal< sc_lv<8> > tmp_34_reg_433;
    sc_signal< sc_lv<8> > tmp_7_reg_438;
    sc_signal< sc_lv<8> > tmp_8_reg_443;
