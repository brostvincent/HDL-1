...
################################################################
set scripts_vivado_version 2015.2.1
...
proc create_hier_cell_filter_rst_1 { parentCell nameHier } {
  ...
  set filter_util_flipflop [ create_bd_cell -type ip -vlnv xilinx.com:user:util_flipflop:1.10.a filter_util_flipflop ]
...
proc create_hier_cell_vid_in_rst_1 { parentCell nameHier } {
  ...
  set tpg_util_flipflop_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:util_flipflop:1.10.a tpg_util_flipflop_1 ]
...
proc create_hier_cell_Fsync_Select { parentCell nameHier } {
  ...
  set async_util_flipflop_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:util_flipflop:1.10.a async_util_flipflop_1 ]
  ...
  set async_util_flipflop_2 [ create_bd_cell -type ip -vlnv xilinx.com:user:util_flipflop:1.10.a async_util_flipflop_2 ]
  ...
  set fsync_util_flipflop_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:util_flipflop:1.10.a fsync_util_flipflop_1 ]
