...
module image_filter_OUTPUT_STREAM_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
...
wire [31:0] output_V_data_V_dout;
wire [0:0]  output_V_data_V_empty_n;
wire [3:0]  output_V_keep_V_dout;
wire [0:0]  output_V_keep_V_empty_n;
wire [3:0]  output_V_strb_V_dout;
...
//------------------------Instantiation------------------
// rs
image_filter_OUTPUT_STREAM_reg_slice #(
    .N       ( 44 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
image_filter_OUTPUT_STREAM_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) output_V_data_V_fifo (
    .clk        ( ACLK ),
...
assign TUSER  = m_data[40:40];
assign TLAST  = m_data[41:41];
assign TID    = m_data[42:42];
assign TDEST  = m_data[43:43];
...
module image_filter_OUTPUT_STREAM_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module image_filter_OUTPUT_STREAM_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
