...
architecture behav of image_filter is 
    ...
    "image_filter,hls_ip_2015_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.640000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=24,HLS_SYN_DSP=24,HLS_SYN_FF=2574,HLS_SYN_LUT=2853}";
    ...
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_data_V_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_data_V_empty_n : STD_LOGIC;
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_data_V_read : STD_LOGIC;
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_keep_V_dout : STD_LOGIC_VECTOR (3 downto 0);
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_keep_V_empty_n : STD_LOGIC;
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_keep_V_read : STD_LOGIC;
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_strb_V_dout : STD_LOGIC_VECTOR (3 downto 0);
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_strb_V_empty_n : STD_LOGIC;
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_strb_V_read : STD_LOGIC;
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_user_V_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_user_V_empty_n : STD_LOGIC;
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_user_V_read : STD_LOGIC;
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_last_V_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_last_V_empty_n : STD_LOGIC;
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_last_V_read : STD_LOGIC;
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_id_V_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_id_V_empty_n : STD_LOGIC;
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_id_V_read : STD_LOGIC;
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_dest_V_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_dest_V_empty_n : STD_LOGIC;
    signal image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_dest_V_read : STD_LOGIC;
    ...
    signal image_filter_AXIvideo2Mat_U0_img_data_stream_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal image_filter_AXIvideo2Mat_U0_img_data_stream_V_full_n : STD_LOGIC;
    signal image_filter_AXIvideo2Mat_U0_img_data_stream_V_write : STD_LOGIC;
    ...
    signal image_filter_Sobel_U0_rows : STD_LOGIC_VECTOR (10 downto 0);
    signal image_filter_Sobel_U0_cols : STD_LOGIC_VECTOR (10 downto 0);
    signal image_filter_Sobel_U0_p_src_data_stream_V_dout : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal image_filter_Sobel_U0_p_dst_data_stream_V_din : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal image_filter_Sobel_1_U0_ap_start : STD_LOGIC;
    signal image_filter_Sobel_1_U0_ap_done : STD_LOGIC;
    signal image_filter_Sobel_1_U0_ap_continue : STD_LOGIC;
    signal image_filter_Sobel_1_U0_ap_idle : STD_LOGIC;
    signal image_filter_Sobel_1_U0_ap_ready : STD_LOGIC;
    signal image_filter_Sobel_1_U0_rows : STD_LOGIC_VECTOR (10 downto 0);
    signal image_filter_Sobel_1_U0_cols : STD_LOGIC_VECTOR (10 downto 0);
    signal image_filter_Sobel_1_U0_p_src_data_stream_V_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal image_filter_Sobel_1_U0_p_src_data_stream_V_empty_n : STD_LOGIC;
    signal image_filter_Sobel_1_U0_p_src_data_stream_V_read : STD_LOGIC;
    signal image_filter_Sobel_1_U0_p_dst_data_stream_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal image_filter_Sobel_1_U0_p_dst_data_stream_V_full_n : STD_LOGIC;
    signal image_filter_Sobel_1_U0_p_dst_data_stream_V_write : STD_LOGIC;
    ...
    signal image_filter_Mat2AXIvideo_U0_img_data_stream_V_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal image_filter_Mat2AXIvideo_U0_img_data_stream_V_empty_n : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_img_data_stream_V_read : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_data_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_data_V_full_n : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_data_V_write : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_keep_V_din : STD_LOGIC_VECTOR (3 downto 0);
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_keep_V_full_n : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_keep_V_write : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_strb_V_din : STD_LOGIC_VECTOR (3 downto 0);
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_strb_V_full_n : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_strb_V_write : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_user_V_din : STD_LOGIC_VECTOR (0 downto 0);
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_user_V_full_n : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_user_V_write : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_last_V_din : STD_LOGIC_VECTOR (0 downto 0);
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_last_V_full_n : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_last_V_write : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_id_V_din : STD_LOGIC_VECTOR (0 downto 0);
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_id_V_full_n : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_id_V_write : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_dest_V_din : STD_LOGIC_VECTOR (0 downto 0);
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_dest_V_full_n : STD_LOGIC;
    signal image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_dest_V_write : STD_LOGIC;
    ...
    signal ap_reg_procdone_image_filter_Sobel_1_U0 : STD_LOGIC := '0';
    ...
    component image_filter_Sobel_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    image_filter_Sobel_1_U0 : component image_filter_Sobel_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    -- ap_reg_procdone_image_filter_Sobel_1_U0 assign process. --
    ap_reg_procdone_image_filter_Sobel_1_U0_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_sig_hs_done)) then 
                    ap_reg_procdone_image_filter_Sobel_1_U0 <= ap_const_logic_0;
                elsif ((ap_const_logic_1 = image_filter_Sobel_1_U0_ap_done)) then 
    ...
    ap_idle_assign_proc : process(image_filter_AXIvideo2Mat_U0_ap_idle, image_filter_Sobel_U0_ap_idle, image_filter_Sobel_1_U0_ap_idle, image_filter_Mat2AXIvideo_U0_ap_idle)
    begin
        if (((image_filter_AXIvideo2Mat_U0_ap_idle = ap_const_logic_1) and (ap_const_logic_1 = image_filter_Sobel_U0_ap_idle) and (ap_const_logic_1 = image_filter_Sobel_1_U0_ap_idle) and (ap_const_logic_1 = image_filter_Mat2AXIvideo_U0_ap_idle))) then 
    ...
    image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_data_V_dout <= input_V_data_V_dout;
    image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_data_V_empty_n <= input_V_data_V_empty_n;
    image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_dest_V_dout <= input_V_dest_V_dout;
    image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_dest_V_empty_n <= input_V_dest_V_empty_n;
    image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_id_V_dout <= input_V_id_V_dout;
    image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_id_V_empty_n <= input_V_id_V_empty_n;
    image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_keep_V_dout <= input_V_keep_V_dout;
    image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_keep_V_empty_n <= input_V_keep_V_empty_n;
    image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_last_V_dout <= input_V_last_V_dout;
    image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_last_V_empty_n <= input_V_last_V_empty_n;
    image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_strb_V_dout <= input_V_strb_V_dout;
    image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_strb_V_empty_n <= input_V_strb_V_empty_n;
    image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_user_V_dout <= input_V_user_V_dout;
    image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_user_V_empty_n <= input_V_user_V_empty_n;
    ...
    image_filter_AXIvideo2Mat_U0_img_data_stream_V_full_n <= img_0_data_stream_0_V_full_n;
    ...
    image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_data_V_full_n <= output_V_data_V_full_n;
    image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_dest_V_full_n <= output_V_dest_V_full_n;
    image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_id_V_full_n <= output_V_id_V_full_n;
    image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_keep_V_full_n <= output_V_keep_V_full_n;
    image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_last_V_full_n <= output_V_last_V_full_n;
    image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_strb_V_full_n <= output_V_strb_V_full_n;
    image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_user_V_full_n <= output_V_user_V_full_n;
    ...
    image_filter_Mat2AXIvideo_U0_img_data_stream_V_dout <= img_2_data_stream_0_V_dout;
    image_filter_Mat2AXIvideo_U0_img_data_stream_V_empty_n <= img_2_data_stream_0_V_empty_n;
    ...
    image_filter_Sobel_1_U0_ap_start <= ap_start;
    
    image_filter_Sobel_1_U0_cols_proc : process(cols)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable image_filter_Sobel_1_U0_cols_i : integer;
    variable section : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable tmp_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable resvalue, res_value, res_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    begin
        ...
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            vhi_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_B(5-1 downto 0)));
            vlo_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_0(5-1 downto 0)));
            for image_filter_Sobel_1_U0_cols_i in 0 to 32-1 loop
                v0_cpy(image_filter_Sobel_1_U0_cols_i) := cols(32-1-image_filter_Sobel_1_U0_cols_i);
            end loop;
        end if;
        res_value := std_logic_vector(shift_right(unsigned(v0_cpy),to_integer(unsigned('0' & vlo_cpy(5-1 downto 0)))));
        ...
        res_mask := res_mask(32-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        image_filter_Sobel_1_U0_cols <= resvalue(11-1 downto 0);
    end process;

    image_filter_Sobel_1_U0_p_dst_data_stream_V_full_n <= img_2_data_stream_0_V_full_n;
    image_filter_Sobel_1_U0_p_src_data_stream_V_dout <= img_1_data_stream_0_V_dout;
    image_filter_Sobel_1_U0_p_src_data_stream_V_empty_n <= img_1_data_stream_0_V_empty_n;
    
    image_filter_Sobel_1_U0_rows_proc : process(rows)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable image_filter_Sobel_1_U0_rows_i : integer;
    variable section : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable tmp_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable resvalue, res_value, res_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    begin
        ...
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            vhi_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_B(5-1 downto 0)));
            vlo_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_0(5-1 downto 0)));
            for image_filter_Sobel_1_U0_rows_i in 0 to 32-1 loop
                v0_cpy(image_filter_Sobel_1_U0_rows_i) := rows(32-1-image_filter_Sobel_1_U0_rows_i);
            end loop;
        end if;
        res_value := std_logic_vector(shift_right(unsigned(v0_cpy),to_integer(unsigned('0' & vlo_cpy(5-1 downto 0)))));
        ...
        res_mask := res_mask(32-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        image_filter_Sobel_1_U0_rows <= resvalue(11-1 downto 0);
    end process;

    image_filter_Sobel_U0_ap_continue <= ap_const_logic_1;
    image_filter_Sobel_U0_ap_start <= ap_start;
    
    image_filter_Sobel_U0_cols_proc : process(cols)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable image_filter_Sobel_U0_cols_i : integer;
    variable section : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable tmp_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable resvalue, res_value, res_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    begin
        ...
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            vhi_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_B(5-1 downto 0)));
            vlo_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_0(5-1 downto 0)));
            for image_filter_Sobel_U0_cols_i in 0 to 32-1 loop
                v0_cpy(image_filter_Sobel_U0_cols_i) := cols(32-1-image_filter_Sobel_U0_cols_i);
            end loop;
        end if;
        res_value := std_logic_vector(shift_right(unsigned(v0_cpy),to_integer(unsigned('0' & vlo_cpy(5-1 downto 0)))));
        ...
        res_mask := res_mask(32-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        image_filter_Sobel_U0_cols <= resvalue(11-1 downto 0);
    end process;

    image_filter_Sobel_U0_p_dst_data_stream_V_full_n <= img_1_data_stream_0_V_full_n;
    image_filter_Sobel_U0_p_src_data_stream_V_dout <= img_0_data_stream_0_V_dout;
    image_filter_Sobel_U0_p_src_data_stream_V_empty_n <= img_0_data_stream_0_V_empty_n;
    
    image_filter_Sobel_U0_rows_proc : process(rows)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable image_filter_Sobel_U0_rows_i : integer;
    variable section : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable tmp_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable resvalue, res_value, res_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    begin
        ...
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            vhi_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_B(5-1 downto 0)));
            vlo_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_0(5-1 downto 0)));
            for image_filter_Sobel_U0_rows_i in 0 to 32-1 loop
                v0_cpy(image_filter_Sobel_U0_rows_i) := rows(32-1-image_filter_Sobel_U0_rows_i);
            end loop;
        end if;
        res_value := std_logic_vector(shift_right(unsigned(v0_cpy),to_integer(unsigned('0' & vlo_cpy(5-1 downto 0)))));
        ...
        res_mask := res_mask(32-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        image_filter_Sobel_U0_rows <= resvalue(11-1 downto 0);
    end process;

    img_0_data_stream_0_V_U_ap_dummy_ce <= ap_const_logic_1;
    img_0_data_stream_0_V_din <= image_filter_AXIvideo2Mat_U0_img_data_stream_V_din;
    img_0_data_stream_0_V_read <= image_filter_Sobel_U0_p_src_data_stream_V_read;
    img_0_data_stream_0_V_write <= image_filter_AXIvideo2Mat_U0_img_data_stream_V_write;
    img_1_data_stream_0_V_U_ap_dummy_ce <= ap_const_logic_1;
    img_1_data_stream_0_V_din <= image_filter_Sobel_U0_p_dst_data_stream_V_din;
    img_1_data_stream_0_V_read <= image_filter_Sobel_1_U0_p_src_data_stream_V_read;
    img_1_data_stream_0_V_write <= image_filter_Sobel_U0_p_dst_data_stream_V_write;
    img_2_data_stream_0_V_U_ap_dummy_ce <= ap_const_logic_1;
    img_2_data_stream_0_V_din <= image_filter_Sobel_1_U0_p_dst_data_stream_V_din;
    img_2_data_stream_0_V_read <= image_filter_Mat2AXIvideo_U0_img_data_stream_V_read;
    img_2_data_stream_0_V_write <= image_filter_Sobel_1_U0_p_dst_data_stream_V_write;
    input_V_data_V_read <= image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_data_V_read;
    input_V_dest_V_read <= image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_dest_V_read;
    input_V_id_V_read <= image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_id_V_read;
    input_V_keep_V_read <= image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_keep_V_read;
    input_V_last_V_read <= image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_last_V_read;
    input_V_strb_V_read <= image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_strb_V_read;
    input_V_user_V_read <= image_filter_AXIvideo2Mat_U0_AXI_video_strm_V_user_V_read;
    output_V_data_V_din <= image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_data_V_din;
    output_V_data_V_write <= image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_data_V_write;
    output_V_dest_V_din <= image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_dest_V_din;
    output_V_dest_V_write <= image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_dest_V_write;
    output_V_id_V_din <= image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_id_V_din;
    output_V_id_V_write <= image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_id_V_write;
    output_V_keep_V_din <= image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_keep_V_din;
    output_V_keep_V_write <= image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_keep_V_write;
    output_V_last_V_din <= image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_last_V_din;
    output_V_last_V_write <= image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_last_V_write;
    output_V_strb_V_din <= image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_strb_V_din;
    output_V_strb_V_write <= image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_strb_V_write;
    output_V_user_V_din <= image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_user_V_din;
    output_V_user_V_write <= image_filter_Mat2AXIvideo_U0_AXI_video_strm_V_user_V_write;
end behav;
