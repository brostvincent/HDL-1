...
const sc_logic image_filter_Sobel_1::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic image_filter_Sobel_1::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<2> image_filter_Sobel_1::ap_ST_st1_fsm_0 = "1";
const sc_lv<2> image_filter_Sobel_1::ap_ST_st2_fsm_1 = "10";
const sc_lv<32> image_filter_Sobel_1::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<1> image_filter_Sobel_1::ap_const_lv1_1 = "1";
const sc_lv<32> image_filter_Sobel_1::ap_const_lv32_1 = "1";
const sc_lv<2> image_filter_Sobel_1::ap_const_lv2_2 = "10";
const sc_lv<2> image_filter_Sobel_1::ap_const_lv2_3 = "11";
const sc_lv<3> image_filter_Sobel_1::ap_const_lv3_0 = "000";
const sc_lv<4> image_filter_Sobel_1::ap_const_lv4_0 = "0000";
const sc_lv<2> image_filter_Sobel_1::ap_const_lv2_1 = "1";
const sc_lv<3> image_filter_Sobel_1::ap_const_lv3_2 = "10";

image_filter_Sobel_1::image_filter_Sobel_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    apTFilenSS << "image_filter_Sobel_1_sc_trace_" << apTFileNum ++;
...
image_filter_Sobel_1::~image_filter_Sobel_1() {
    if (mVcdFile) 
        sc_close_vcd_trace_file(mVcdFile);

    delete grp_image_filter_Filter2D_fu_56;
}

void image_filter_Sobel_1::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    !esl_seteq<1,1,1>(ap_const_logic_0, grp_image_filter_Filter2D_fu_56_ap_done.read()))) {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_image_filter_Filter2D_fu_56_ap_ready.read())) {
            grp_image_filter_Filter2D_fu_56_ap_start_ap_start_reg = ap_const_logic_0;
        }
    }
}

void image_filter_Sobel_1::thread_ap_done() {
...
void image_filter_Sobel_1::thread_ap_idle() {
...
void image_filter_Sobel_1::thread_ap_ready() {
...
void image_filter_Sobel_1::thread_ap_sig_cseq_ST_st2_fsm_1() {
...
void image_filter_Sobel_1::thread_grp_image_filter_Filter2D_fu_56_ap_start() {
    grp_image_filter_Filter2D_fu_56_ap_start = grp_image_filter_Filter2D_fu_56_ap_start_ap_start_reg.read();
}

void image_filter_Sobel_1::thread_grp_image_filter_Filter2D_fu_56_p_dst_data_stream_V_full_n() {
    grp_image_filter_Filter2D_fu_56_p_dst_data_stream_V_full_n = p_dst_data_stream_V_full_n.read();
}

void image_filter_Sobel_1::thread_grp_image_filter_Filter2D_fu_56_p_kernel_val_0_V_1_read() {
    grp_image_filter_Filter2D_fu_56_p_kernel_val_0_V_1_read = ap_const_lv2_2;
}

void image_filter_Sobel_1::thread_grp_image_filter_Filter2D_fu_56_p_kernel_val_0_V_2_read() {
    grp_image_filter_Filter2D_fu_56_p_kernel_val_0_V_2_read = ap_const_lv2_3;
}

void image_filter_Sobel_1::thread_grp_image_filter_Filter2D_fu_56_p_kernel_val_1_V_0_read() {
    grp_image_filter_Filter2D_fu_56_p_kernel_val_1_V_0_read = ap_const_lv3_0;
}

void image_filter_Sobel_1::thread_grp_image_filter_Filter2D_fu_56_p_kernel_val_1_V_2_read() {
    grp_image_filter_Filter2D_fu_56_p_kernel_val_1_V_2_read = ap_const_lv4_0;
}

void image_filter_Sobel_1::thread_grp_image_filter_Filter2D_fu_56_p_kernel_val_2_V_0_read() {
    grp_image_filter_Filter2D_fu_56_p_kernel_val_2_V_0_read = ap_const_lv2_1;
}

void image_filter_Sobel_1::thread_grp_image_filter_Filter2D_fu_56_p_kernel_val_2_V_1_read() {
    grp_image_filter_Filter2D_fu_56_p_kernel_val_2_V_1_read = ap_const_lv3_2;
}

void image_filter_Sobel_1::thread_grp_image_filter_Filter2D_fu_56_p_src_cols_V_read() {
    grp_image_filter_Filter2D_fu_56_p_src_cols_V_read = cols.read();
}

void image_filter_Sobel_1::thread_grp_image_filter_Filter2D_fu_56_p_src_data_stream_V_dout() {
    grp_image_filter_Filter2D_fu_56_p_src_data_stream_V_dout = p_src_data_stream_V_dout.read();
}

void image_filter_Sobel_1::thread_grp_image_filter_Filter2D_fu_56_p_src_data_stream_V_empty_n() {
    grp_image_filter_Filter2D_fu_56_p_src_data_stream_V_empty_n = p_src_data_stream_V_empty_n.read();
}

void image_filter_Sobel_1::thread_grp_image_filter_Filter2D_fu_56_p_src_rows_V_read() {
    grp_image_filter_Filter2D_fu_56_p_src_rows_V_read = rows.read();
}

void image_filter_Sobel_1::thread_p_dst_data_stream_V_din() {
    p_dst_data_stream_V_din = grp_image_filter_Filter2D_fu_56_p_dst_data_stream_V_din.read();
}

void image_filter_Sobel_1::thread_p_dst_data_stream_V_write() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read())) {
        p_dst_data_stream_V_write = grp_image_filter_Filter2D_fu_56_p_dst_data_stream_V_write.read();
    } else {
        p_dst_data_stream_V_write = ap_const_logic_0;
    }
}

void image_filter_Sobel_1::thread_p_src_data_stream_V_read() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read())) {
        p_src_data_stream_V_read = grp_image_filter_Filter2D_fu_56_p_src_data_stream_V_read.read();
    } else {
        p_src_data_stream_V_read = ap_const_logic_0;
    }
}

void image_filter_Sobel_1::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if (!esl_seteq<1,1,1>(ap_const_logic_0, grp_image_filter_Filter2D_fu_56_ap_done.read())) {
                ap_NS_fsm = ap_ST_st1_fsm_0;
            } else {
                ap_NS_fsm = ap_ST_st2_fsm_1;
            }
