...
#ifndef __image_filter_mul_2s_32s_34_3__HH__
#define __image_filter_mul_2s_32s_34_3__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mul_2s_32s_34_3) {
    ...
    SC_CTOR(image_filter_mul_2s_32s_34_3):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
